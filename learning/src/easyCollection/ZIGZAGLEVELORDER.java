 ...
 * public class easyCollection.TreeNode {
 * int val;
 * easyCollection.TreeNode left;
 * easyCollection.TreeNode right;
 * easyCollection.TreeNode() {}
 * easyCollection.TreeNode(int val) { this.val = val; }
 * easyCollection.TreeNode(int val, easyCollection.TreeNode left, easyCollection.TreeNode right) {
 * this.val = val;
 * this.left = left;
 * this.right = right;
 * }
